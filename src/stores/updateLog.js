    ...
    const updateLogInfo = [
        {
            version: '4.5.1', 
            date: '2026-08-26', 
            title: '修正 4.5 版本多选一成就数据',
            changes: '<ul><li>修正 4.5 版本多选一成就数据</li></ul>' 
        },        
        {
            version: '4.5.0', 
            date: '2026-08-26', 
            title: '更新 4.5 版本成就相关数据，更新 4.5 版本角色相关数据',
            changes: '<ul><li>更新 4.5 版本成就相关数据</li><li>更新 4.5 版本角色相关数据</li></ul>' 
        },
        {
            version: '4.4.1', 
            date: '2026-07-30', 
            title: '更新 4.4 版本联动成就相关数据',
            changes: '<ul><li>更新 4.4 版本联动成就相关数据</li></ul>' 
        },
        {
            version: '4.4.0', 
            date: '2026-07-15', 
            title: '更新 4.4 版本成就相关数据，更新 4.4 版本角色相关数据',
            changes: '<ul><li>更新 4.4 版本成就相关数据</li><li>更新 4.4 版本角色相关数据</li></ul>' 
        },
        {
            version: '4.3.0', 
            date: '2026-06-01', 
            title: '更新 4.3 版本成就相关数据',
            changes: '<ul><li>更新 4.3 版本成就相关数据</li></ul>' 
        },
        {
            version: '4.2.0', 
            date: '2026-04-22', 
            title: '更新 4.2 版本成就相关数据',
            changes: '<ul><li>更新 4.2 版本成就相关数据</li></ul>' 
        },
        {
            version: '4.1.0', 
            date: '2026-03-25', 
            title: '更新 4.1 版本成就相关数据，更新 4.1 版本角色相关数据',
            changes: '<ul><li>更新 4.1 版本成就相关数据</li><li>更新 4.1 版本角色相关数据</li></ul>' 
        },
        {
            version: '4.0.2', 
            date: '2026-02-16', 
            title: '修正 4.0 版本多选一成就数据',
            changes: '<ul><li>修正 4.0 版本多选一成就数据</li></ul>' 
        },
        {
            version: '4.0.1', 
            date: '2026-02-14', 
            title: '更新 4.0 版本角色相关数据',
            changes: '<ul><li>更新 4.0 版本角色相关数据</li></ul>' 
        },
        {
            version: '4.0.0', 
            date: '2026-02-13', 
            title: '更新 4.0 版本成就相关数据',
            changes: '<ul><li>更新 4.0 版本成就相关数据</li></ul>' 
        },
        {
            version: '3.8.0', 
            date: '2025-12-17', 
            title: '更新 3.8 版本成就相关数据',
            changes: '<ul><li>更新 3.8 版本成就相关数据</li></ul>' 
        },
        {
            version: '3.7.0', 
            date: '2025-11-05', 
